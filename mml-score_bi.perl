...
my ($corpus_stem,$query,$source_lang,$target_lang,$domain_file,$filter_domains);
...
my $source_inlm = "in-source.blm";
my $target_inlm = "in-target.blm";
my $source_outlm = "out-source.blm";
my $target_outlm = "out-target.blm";
